...
statement:
    ...
    ----> The addition operation will require conversion of the value of i to float, and the assignment 
            operation will require conversion of the summed value to double.
*/